...
- [ ] **Task 1.1: Project Initialization & Routing Setup**
  ...
  - *Proof of Done*: App compile không lỗi với `npm run dev` tại cổng 3001.

- [ ] **Task 1.2: Design Tokens & Tailwind Configuration (Booking.com Style)**
...
- [ ] **Task 1.3: Core Layout & Navigation Components**
...
- [ ] **Task 1.4: Auth Integration & Role Guards (`POST /auth/login`, `/register`, `GET /auth/me`)**
...
- [ ] **Task 2.1: Host Layout & Navigation Bar**
...
- [ ] **Task 2.2: Master Data Amenity Management UI (`GET /amenities`, `POST /amenities`)**
...
- [ ] **Task 2.3: Form Tạo / Chỉnh sửa Khách sạn (Hotel CRUD UI - `POST /hotels`, `GET /hotels/my-hotels`)**
...
- [ ] **Task 2.4: Form Quản lý Loại phòng & Inventory (`POST /hotels/:hotelId/rooms`)**
...
- [ ] **Task 3.1: Booking.com Style Hero Search Box & Client Validation**
...
- [ ] **Task 3.2: Filter Sidebar & Sorting Controls (Trang Results `/search`)**
...
- [ ] **Task 3.3: Property Result Cards & Semantic Match Score Badge**
...
- [ ] **Task 3.4: Integration với API `GET /api/v1/search`**
...
- [ ] **Task 4.1: Hotel Detail Page (`/hotels/[id]`)**
...
- [ ] **Task 4.2: Interactive Room Selection Table & Dynamic Price Breakdown (`POST /bookings/calculate-price`)**
...
- [ ] **Task 4.3: Checkout Page & Temporary Hold Timer Countdown (15 phút - `POST /bookings/hold`)**
...
- [ ] **Task 4.4: Guest Info Form, Coupon Validation & Booking Submit (`POST /bookings`)**
...
- [ ] **Task 4.5: User Booking History & Cancellation Policy Modal (`POST /bookings/:id/cancel`)**
...
- [ ] **Task 5.1: Dynamic Pricing & Seasonal Calendar Editor (Host)**
...
- [ ] **Task 5.2: Host Booking Management & Status Updates (`PATCH /host/bookings/:id/status`)**
...
- [ ] **Task 5.3: Host & Admin Revenue Analytics Charts**
...
- [ ] **Task 5.4: Admin Platform Governance Portal (`/admin`)**
...
- [ ] **Task 6.1: Verified Review & Rating Module (`POST /hotels/:hotelId/reviews`)**
...
- [ ] **Task 6.2: Real-time 1-1 Messaging System (Socket.io - `GET /messages/:bookingId`)**
...
- [ ] **Task 6.3: Micro-animations & UX Polish**
...
- [ ] **Task 6.4: SEO & Performance Optimization**
...
|---|---|---|---|---|---|
| 2026-08-12 | Phase 1 - General | Khởi tạo & Đồng bộ cấu trúc tracking Frontend khớp 100% với Backend Core Constraints | AI Agent | 🟡 In Progress | Đã bổ sung chi tiết ràng buộc Hủy phòng, Đánh giá CHECKED_OUT, Dynamic Price breakdown & Socket Chat |
| ... | ... | ... | ... | ... | ... |
